...
export function ImportPreviewModal({
  ...
  onConfirm,
  onCancel,
}: ImportPreviewModalProps): React.ReactElement | null {
      ...
      <div className="flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl bg-[var(--bg-default)] shadow-2xl">
        ...
        <div className="border-b border-[var(--border)] bg-[var(--bg-subtle)] p-6">
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
            ...
            <SummaryCard
              value={previewData.summary.newProducts}
              label="Nuevos"
              variant="success"
            />
            <SummaryCard
              value={previewData.summary.updates}
              label="Actualizaciones"
              variant="info"
            />
            <SummaryCard
              value={previewData.summary.adjustments}
              label="Ajustes Stock"
              variant="warning"
            />
            <SummaryCard
              value={previewData.summary.errors}
              label="Errores"
              variant="error"
            />
            <SummaryCard
              value={previewData.summary.skipped}
              label="Omitidos"
              variant="muted"
            />
          </div>
